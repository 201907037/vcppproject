// 201907037vcppProject.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "framework.h"
#include "201907037vcppProject.h"
#include <stdlib.h>
#include <time.h>
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY201907037VCPPPROJECT, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY201907037VCPPPROJECT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY201907037VCPPPROJECT));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY201907037VCPPPROJECT);
                ...
                if (true == IntersectRect(&s, &g_bait, &trash[i])) {
                    ...
                    else
                    {
                        ...
                        if (hp == 0) {
                            ...
                            ship_flag = 0;
                            score = 0;
                            MessageBox(hWnd, scorestr, L"알림", MB_OK);
